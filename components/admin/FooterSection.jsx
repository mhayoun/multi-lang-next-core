    ...
    return (
        <div className="max-w-4xl mx-auto space-y-4 pb-10">
            <AccordionItem
                ...
                actions={
                    <button onClick={() => handleUpdate(f => f.hours.items.push({ label: { he: '', en: '' }, value: { he: '', en: '' }, isLink: false }))}
            ...
            <AccordionItem index={1} title={footer.contact.title} icon={MapPin} lang={lang} isOpen={openIndex === 1} setOpenIndex={setOpenIndex}>
