...
const FooterSection = ({ logic, isHe }) => {
    ...
    // New function to update Section Titles (hours.title or contact.title)
    const handleSectionTitleChange = (section, value) => {
        const updatedFooter = JSON.parse(JSON.stringify(footer));
        if (!updatedFooter[section].title) updatedFooter[section].title = { he: '', en: '' };
        updatedFooter[section].title[lang] = value;
    ...
    const handleContactChange = (field, value, isMultilang = false) => {
        ...
        if (isMultilang) {
            ...
            updatedFooter.contact.transport.he = value;
        } else {
            updatedFooter.contact[field] = value;
        }
        updateFooter(updatedFooter);
        ...
        <div className="max-w-4xl mx-auto space-y-4 pb-10">
            ...
            >
                <div className="grid grid-cols-1 gap-4">
                    {/* Header Editor for Section Title */}
                    <div className="p-3 bg-blue-50/50 rounded-xl border border-blue-100">
                        ...
                        <input
                            ...
                            onChange={(e) => handleSectionTitleChange('hours', e.target.value)}
                        />
                    </div>
            ...
            <AccordionItem index={1} title={footer.contact.title} icon={MapPin}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    {/* Header Editor for Contact Section Title */}
                    <div className="md:col-span-2 p-3 bg-blue-50/50 rounded-xl border border-blue-100">
                        ...
                        <input
                            ...
                            onChange={(e) => handleSectionTitleChange('contact', e.target.value)}
                        />
                    </div>
